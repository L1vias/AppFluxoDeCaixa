...
namespace AppFluxoDeCaixa.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,Nome,CNPJ,Email,Telefone,DataDeCadastro,Ativo")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FornecedorId,Nome,CNPJ,Email,Telefone,DataDeCadastro,Ativo")] Fornecedor fornecedor)
        {
